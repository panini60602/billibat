...
class _BannerState extends State<BannerSample> {
  ...
  String get apiKey {
    switch (bannerSize) {
      case BannerSize.type728x90:
        return Platform.isAndroid ? '02e6e186bf0183105fba7ce310dafe68ac83fb1c' : '2e0b9e0b3f40d952e6000f1a8c4d455fffc4ca3a';
      case BannerSize.type320x100:
        return Platform.isAndroid ? '8932b68d22d1d32f5d7251f9897a6aa64117995e' : 'eb5ca11fa8e46315c2df1b8e283149049e8d235e';
      case BannerSize.type300x100:
        return Platform.isAndroid ? '1e36d1183d1ab66539998df4170a591c13028416' : '25eb32adddc4f7311c3ec7b28eac3b72bbca5656';
      case BannerSize.type300x250:
        return Platform.isAndroid ? '499f011dbec5d37cfa388b749aed2bfff440a794' : '88d88a288fdea5c01d17ea8e494168e834860fd6';
      case BannerSize.type320x50:
      default:
        return Platform.isAndroid ? 'c5cb8bc474345961c6e7a9778c947957ed8e1e4f' : 'a6eca9dd074372c898dd1df549301f277c53f2b9';
    }
  }
}
